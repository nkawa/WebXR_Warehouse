        ...
        for (var i = 0; i < this.children.length; i++) {
            ...
            if (childGuiItem) {
                if (this.data.flexDirection == 'row') {
                    ...
                    cursorX = cursorX + childGuiItem.margin.w + childGuiItem.width + childGuiItem.margin.y  + this.data.itemPadding;
                } else if (this.data.flexDirection == 'column') {
                    if (this.data.alignItems == 'center') {
                    ...
                    cursorY = cursorY + childGuiItem.margin.x + childGuiItem.height + childGuiItem.margin.z + this.data.itemPadding;
                }
