AFRAME.registerComponent('gui-button', {
    schema: {
        myFunc: { type: 'string', default: 'def' },
        on: { default: 'click' },
        value: { type: 'string', default: '' },
        clickArg: { type: 'string', default: '' },
    ...
    init: function () {
        ...
        */
            ...
            /*
        console.log("Init button with",guiInteractable)
        console.log("ini",this.data.value)
        console.log("2",this.data.on)
        console.log("Cf", this.data.myFunc, this.data.clickArg)
*/
        var myFunc = this.data.myFunc;
        this.myFunc = myFunc;
        console.log("MyFunc", myFunc, this.data.clickArg, this.el);
        this.el.myFunc = myFunc;
...
//                var clickActionFunctionName = guiInteractable.clickAction;
                var clickActionFunctionName = el.myFunc;
// find object
                var clickActionFunction = window[clickActionFunctionName];
                console.log("clickActionFunction: ["+clickActionFunction,"]",clickActionFunctionName );
                // is object a function?
                if (typeof clickActionFunction === "function") clickActionFunction(event, data.clickArg);
            }
        });
...
AFRAME.registerPrimitive('a-gui-button', {
    ...
    mappings: {
        ...
        //gui button specific
        'click-func': 'gui-button.myFunc',
        'on': 'gui-button.on',
        'click-arg': 'gui-button.clickArg',
